...
func InitConfig(filePath string) {
	...
	for k, v := range flagConfig {
		...
		case "doge_height":
			Config.Doge.InitialHeight, _ = strconv.ParseInt(*v, 10, 64)
		case "doge_rpc_host":
			Config.Doge.RpcHost = *v
		case "doge_rpc_user":
			Config.Doge.RpcUser = *v
		case "doge_rpc_password":
...
func GetFlagConfig() (flagConfig map[string]*string, configFile string) {
	...
	flagConfig["doge_height"] = flag.String("doge_height", "", "doge starting block height")
	flagConfig["doge_rpc_host"] = flag.String("doge_rpc_host", "", "doge rpc host")
